 ...
 */
	...
	//Insert Teacher Data
	public function userCakeAddTeacher()
	{
		global $mysqli,$emailActivation,$websiteUrl,$db_table_prefix;
		if($this->status)
		{
			...
			if($emailActivation == "true")
			{
				...
				if(!$mail->newTemplateMsg("new-registration.txt",$hooks)){ $this->mail_failure = true; }
				else
				{
					if(!$mail->sendMail($this->clean_email,"New User")){ $this->mail_failure = true; }
				}
				$this->success = lang("ACCOUNT_REGISTRATION_COMPLETE_TYPE2");
			}
			else
	...
	//Insert Teacher Data
	public function userCakeAddNurse()
	{
		global $mysqli,$emailActivation,$websiteUrl,$db_table_prefix;
		if($this->status)
		{
