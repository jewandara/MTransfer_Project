...
//Hospitels
$lang = array_merge($lang,array(
	"HOSPITAL_CHAR_LIMIT"			=> "Hospitel names must be between %m1% and %m2% characters in length",
	"HOSPITAL_NUMBER_LIMIT"			=> "Hospitel Number must be between %m1% and %m2% intergers in length",
	"HOSPITAL_NUMBER_IN_USE"		=> "Hospitel Number %m1% is already in use",
	"HOSPITAL_IS_NUMERIC"			=> "Hospitel Number '%m1%' should be a Integer value.",
	"HOSPITAL_DELETIONS_SUCCESSFUL"	=> "Successfully deleted %m1% Hospitel level(s)",
	"HOSPITAL_CREATION_SUCCESSFUL"	=> "Successfully created the Hospitel level `%m1%`",
	"HOSPITAL_SELECT_TYPE"		=> "Select the type of the hospitel '%m1%'.",
	"HOSPITAL_SELECT_DISTRICT"	=> "Select the District of the hospitel '%m1%'.",
	"HOSPITEL_NAME_UPDATE"		=> "Hospitel is updated successfully",
	"HOSPITEL_REMOVE_PAGES"		=> "Successfully removed access to %m1% page(s)",
	"HOSPITEL_ADD_PAGES"			=> "Successfully added access to %m1% page(s)",
	"HOSPITEL_REMOVE_USERS"		=> "Successfully removed %m1% user(s)",
	"HOSPITEL_ADD_USERS"			=> "Successfully added %m1% user(s)",
	"CANNOT_DELETE_HOSPITEL"		=> "You cannot delete the default 'New Hospitel' group",
	));
?>