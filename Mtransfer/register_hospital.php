                ...
                <div class='row'>
                    <div class='col-sm-8 col-sm-offset-2' data-form-type='formoid'>
                        <div class='mbr-header mbr-header--center mbr-header--std-padding'>
                            <h2 class='mbr-header__text'><img src='assets/images/hospitil.png' class='mbr-figure__img' width='150px'>    Register For Hospital</h2>
                        </div>
...
<form name='newUser' action='".$_SERVER['PHP_SELF']."' method='post' data-form-title='Regisester New Nurse'>
...
<div class='form-group'>
	...
	<input type='text' name='displayname' class='form-control' required placeholder='GOVERNMENT ID ( Ex: NIC NO / NURSE REG NO )' data-form-field='Name'>
</div>
...
<div class='mbr-buttons mbr-buttons--right'>
	<button type='submit' class='mbr-buttons__btn btn btn-lg btn-primary'>REGISTER AS NURCE</button>
</div>
